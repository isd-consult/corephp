...
/*		数据库配置		*/
$conf['db']['dsn']='mysql:host=localhost;dbname=cai';
$conf['host']='localhost';
$conf['port']='3306';
$conf['db']['user']='root';
$conf['db']['password']='';
...
$conf['cache']['dirqiantai']='D:\\web\\web\\+qq10001056\\'; //此处设置前台缓存目录,请写绝对路径
$conf['cache']['dirwap']='D:\\web\wap\\_cache_$98sER9@fw!d#s4fef\\'; //此处设置手机站前台缓存目录,请写绝对路径
$conf['url_modal']=2;
