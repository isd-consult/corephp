...
<form name="buy" method="post" id="buy" >
	<header>
		<h3 class="tabs_involved">彩种时间设置&nbsp;&nbsp;<a href="time/add/<?=$this->type?>">添加</a><a href="/admin778899.php/time/updateAllTimes" target="ajax"  id="plxg" style="margin-left:300px" call="sysUpdateTime">批量修改</a></h3>
	</header>
	...
	<table class="tablesorter" cellspacing="0">
		...
		<tbody>
			...
			<tr>
				...
				<td><a href="/admin778899.php/time/updateTimes/<?=$var['type']?>/<?=$var['id']?>" target="ajax" method="POST" onajax="sysBeforeUpdateTime" call="sysUpdateTime">保存修改</a> 
...
<script>
	...
	$.getJSON("/admin778899.php/time/updateAllTimes",$('#buy').serialize(),function(data){
