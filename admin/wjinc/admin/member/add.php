...
if($userarr){
	foreach($userarr as $var){
		if($var['type']==3){
			$gudong.='<option value="'.$var['uid'].'">'.$var['username'].'</option>';
		}
		if($var['type']==2){
			$zparent.='<option value="'.$var['uid'].'">'.$var['username'].'</option>';
		}
		if($var['type']==1){
			$parent.='<option value="'.$var['uid'].'">'.$var['username'].'</option>';
		}
	}
}
?>            
