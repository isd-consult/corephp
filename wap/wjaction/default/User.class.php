...
*/	
	...
	public final function registered(){
		...
		}elseif($linkData['type']==0 && $parentinfo['type']==1){
			//添加会员
		...
		if(!$para['email']) $para['email']='';
		if(!$para['phone']) $para['phone']='';
		if(!$para['conCommStatus']) $para['conCommStatus']=0;
		if(!$para['lossCommStatus']) $para['lossCommStatus']=0;
		if(!$para['care']) $para['care']='';
