...
var UserBet = {
    ...
    getStats: function() {
        if (UserBet.gameId == 10 || UserBet.gameId == 11 || UserBet.gameId == 12 || UserBet.gameId == 13 || UserBet.gameId == 14 || UserBet.gameId == 75) {
            ...
            function(c) {
                if (c) {
                    var e = "";
                    var b = '<tr class="u-tb5-tr{className}"><th align="center">{turnNum}</th> <td class="K3Term"><b class="b{n1}">{n1}</b></td> <td class="K3Term"><b class="b{n2}">{n2}</b></td> <td class="K3Term"><b class="b{n3}">{n3}</b></td> <td style="text-align: center;">{totalDesc}</td> </tr>';
                    $(c).each(function(j, p) {
                                                ...
                                                if (b == 66) {
                                                    ...
                                                    if (b == 72) {
                                                        ...
                                                        if (b == 73) {
                                                            ...
                                                            if (b == 13) {
                                                                c = "/game/hbk3/history.html"
                                                              }
                                                            }
															else {
                                                            if (b == 14) {
                                                                c = "/game/nmgk3/history.html"
                                                              }
                                                            }
