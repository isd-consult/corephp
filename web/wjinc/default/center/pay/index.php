	...
	<div class="memberinfo floatleft">
		...
		<div class="steps">
			...
			<div class="tabs">
               ...
               <!-- <?php if (isset($this->bankList['onlinePayment'])) {?>
				...
				<div class="tab" id="tp_sf_zfb" payval="onlinePayment" title="sfzfb">zfb在线</div>-->
			
				<div class="tab" id="tp_sf_wx" payval="onlinePayment" title="sfwx">微信zx</div>
				...
				<div class="tab hide" id="tp_zfb" payval="alipay" onclick="Pay.initAWRechCfg(this);" title="支付宝转账"><?=$this->bankList['alipay']['name']?></div>
                <?php }?>
                <?php if (isset($this->bankList['cft'])) {?>
				<div class="tab hide" id="tp_cft" payval="cft" onclick="Pay.initCft(this);" title="网银转帐">网银转帐</div>
                <?php }?>
			</div>
		</div>
		<div class="subcontent" id="subpagetp_zxzf">
			...
			<form id="zxzf_form" method="post" onsubmit="return Pay.onlinePay('zxzf');" target="_blank" action="/userrech/onlinePay.do">
				...
				<div class="subrow" style="display: block;">
					...
					<div class="subcol2 hide" id="bf-banks">
						<div class="banklist marginbtm10">
							<input type="radio" id="3002" name="payId" value="ICBC" class="bankradiobtn">
							<i class="ico-icbc"></i>
							<span style="padding-right: 8px;">工商银行</span>
						</div>
						<div class="banklist marginbtm10">
							<input type="radio" id="3003" name="payId" value="CBC" class="bankradiobtn">
							<i class="ico-ccb"></i>
							<span style="padding-right: 8px;">建设银行</span>
						</div>
						<div class="banklist marginbtm10">
							<input type="radio" id="3005" name="payId" value="ABC" class="bankradiobtn">
							<i class="ico-abc"></i>
							<span style="padding-right: 8px;">农业银行</span>
						</div>
						<div class="banklist marginbtm10">
							<input type="radio" id="3020" name="payId" value="COMM" class="bankradiobtn">
							<i class="ico-boco"></i>
							<span style="padding-right: 8px;">交通银行</span>
						</div>
						<div class="banklist marginbtm10">
							<input type="radio" id="3026" name="payId" value="BOC" class="bankradiobtn">
							<i class="ico-boc"></i>
							<span style="padding-right: 8px;">中国银行</span>
						</div>
						<div class="banklist marginbtm10">
							<input type="radio" id="3022" name="payId" value="CEB" class="bankradiobtn">
							<i class="ico-cebb"></i>
							<span style="padding-right: 8px;">光大银行</span>
						</div>
						<div class="banklist marginbtm10">
							<input type="radio" id="3006" name="payId" value="CMBC" class="bankradiobtn">
							<i class="ico-cmbc"></i>
							<span style="padding-right: 8px;">民生银行</span>
						</div>
						<div class="banklist marginbtm10">
							<input type="radio" id="3038" name="payId" value="PSBC" class="bankradiobtn">
							<i class="ico-post"></i>
							<span style="padding-right: 8px;">邮政银行</span>
						</div>
						<div class="banklist marginbtm10">
							<input type="radio" id="3001" name="payId" value="CMB"
								class="bankradiobtn"> <i class="ico-cmb"></i>
							<span style="padding-right: 8px;">招商银行</span>
						</div>
						<div class="banklist marginbtm10">
							<input type="radio" id="3009" name="payId" value="CIB"
				...
				<div class="subrow margintop30">
					<div class="subcol1"></div>
					<div class="subcol2">
						<input type="submit" class="c-button" style="cursor:pointer" value="开始充值">
					</div>
				</div>
			</form>
		</div>
		...
		<div class="subcontent" style="display: none" id="subpagetp_zfb">
			...
			<div class="subrow">
				...
				<div id="aw-subcol" class="subcol2" style="width: 220px"></div>
								<span class="validation" style="display: block; padding-top: 10px;">
					<img src="/static/images/iconwarning.jpg" width="17" height="15" alt=""> <span class="smalltxt red">支付宝提示转账成功后,需提交存款信息</span>
				</span>
			</div>
			<div class="subrow">
				<div class="subcol1"></div>
        ...
        <div class="subcontent" style="display: none" id="subpagetp_cft">
			...
			<div class="subrow">
				<div class="subcol1">支付帐户：</div>
				<div id="cft-subcol" class="subcol2" style="width: 220px"></div>
								<span class="validation" style="display: block; padding-top: 10px;">
					<img src="/static/images/iconwarning.jpg" width="17" height="15" alt=""> <span class="smalltxt red">支持跨行汇款,支付宝可直接转此卡.</span>
				</span>
			</div>
			<div class="subrow">
				<div class="subcol1"></div>
