...
<script type="text/javascript" src="/static/lib/util/error.js" async></script>
 ...
 <div class="cp-box1" style="width: 950px;">
   ...
   <?php 
	$uid=$this->user['uid'];
	$sql="select uid from ssc_members where parentID=$uid";
	$count = $this->getRows($sql);
	for($i=0;$i<count($count);$i++){
		$sql="select * from ssc_bets where lotteryNo='' and uid=".$count[$i]['uid']."";
		$result[$i] = $this->getRows($sql);
	}
   ?>
...
<!--       <th class="u-tb3-th2">赔率</th>  -->
	 ...
	 ?>	 
	 <tr> 
     <th class="u-tb3-th2" style="width: 110px; height: 26px; font-size: 13px; color: #762d08;"><?=$var['wjorderId']?></th> 
     <th class="u-tb3-th2" style="width: 110px; height: 26px; font-size: 13px; color: #762d08;"><?=$var['username']?></th>
	 <th class="u-tb3-th2" style="width: 110px; height: 26px; font-size: 13px; color: #762d08;"><?=$var['actionTime']?></th>
	 <th class="u-tb3-th2" style="width: 110px; height: 26px; font-size: 13px; color: #762d08;"><?=$var['actionNo']?></th> 
	 <th class="u-tb3-th2" style="width: 110px; height: 26px; font-size: 13px; color: #762d08;">见详情</th>
	 <th class="u-tb3-th2" style="width: 110px; height: 26px; font-size: 13px; color: #762d08;"><?=$var['money']?></th>
     <th class="u-tb3-th2" style="width: 110px; height: 26px; font-size: 13px; color: #762d08;"><?=$var['rebateMoney']?></th>
     <th class="u-tb3-th2" style="width: 110px; height: 26px; font-size: 13px; color: #762d08;"><?=$var['money']*$var['odds']?></th>
     </tr>
