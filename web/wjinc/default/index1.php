...
//		PullMsg.getLotteryData();
    ...
    $(function () {
	 ...
	 function shipinzhibo(url,titlename){
    	if(typeof($(".layui-layer-iframe").html())!="undefined"){
    		layer.alert('你已经打开过了开奖直播！！');
    		return false;
    	}
    	layer.open({
    		type: 2,
    ...
    <div class="header">
        <div class="logo2" style="text-align: center;">
            <!--<img src='' alt="<?= $this->iff($args[0], $args[0] . '－') . $this->settings['webName'] ?>" height="53"
                 id="domain_logo_url">-->
                 <img src="../../skin/17/dsn_mb_logo.png"  height="53" />
            <script type="text/javascript">
                //处理默认样式
                changePageSkin();
            </script>
        ...
        <div class="menu2">
            ...
            <!--<span id="skinPanel">更换皮肤</span>-->
             <div class="trial-cls menu4"><a href="" class="support">刷新网页</a></div>

        </div>
         <ul class="color1"><li><i style="background:#dc2f39"></i><a href="javascript:changeSkin('red')">红色</a></li><li><i style="background:#5382bc"></i><a href="javascript:changeSkin('blue')">蓝色</a></li></ul>
        ...
        <div class="sub" id="homeCateMenus">
            <div id="cate_menus_50" class="show cate_menu">
                ...
                |
		        <a style="background: linear-gradient(to bottom, #ff925f 0%,#ff7340 100%);color: #FFFFFF;cursor: pointer; border: 1px solid #ff6835; border-radius: 3px;margin-top:3px"  onclick="shipinzhibo('http://www.163kai.com/threeLevelPage/lotteryQuote.html?lotType=9&width=781&height=510','北京赛车pk10直播');"  >视频开奖</a>
            </div>
            ...
            <div id="cate_menus_55" class="show cate_menu">
                ...
                |
				<a style="background: linear-gradient(to bottom, #ff925f 0%,#ff7340 100%);color: #FFFFFF;cursor: pointer; border: 1px solid #ff6835; border-radius: 3px;margin-top:3px" onclick="shipinzhibo('http://www.163kai.com/threeLevelPage/lotteryQuote.html?lotType=38&width=781&height=510','幸运飞艇直播');" >视频开奖</a> 
            </div>
            <div id="cate_menus_1" class="hide cate_menu">
                ...
                <a href="/game/cqssc/sol.html?ball=5" onclick="HomeMenu.selCateMenuClass(this);" target="framePage"
                   cate_id="6">第五球</a>
				   	|
                <a style="background: linear-gradient(to bottom, #ff925f 0%,#ff7340 100%);color: #FFFFFF;cursor: pointer; border: 1px solid #ff6835; border-radius: 3px;margin-top:3px"  onclick="shipinzhibo('http://www.163kai.com/threeLevelPage/lotteryQuote.html?lotType=5&width=781&height=510','重庆时时彩直播');"  >视频开奖</a>
            ...
            <div id="cate_menus_60" class="hide cate_menu">
                ...
                <a href="/game/gdkl10/lm.html" onclick="HomeMenu.selCateMenuClass(this);" target="framePage"
                   cate_id="12">连码</a>
				|
                <a style="background: linear-gradient(to bottom, #ff925f 0%,#ff7340 100%);color: #FFFFFF;cursor: pointer; border: 1px solid #ff6835; border-radius: 3px;margin-top:3px"  onclick="shipinzhibo('http://www.163kai.com/threeLevelPage/lotteryQuote.html?lotType=27&width=781&height=510','广东快乐10分直播');"  >视频开奖</a>
            </div>
            <div id="cate_menus_10" class="hide cate_menu">
				...
				|
                <a style="background: linear-gradient(to bottom, #ff925f 0%,#ff7340 100%);color: #FFFFFF;cursor: pointer; border: 1px solid #ff6835; border-radius: 3px;margin-top:3px"  onclick="shipinzhibo('http://www.163kai.com/threeLevelPage/lotteryQuote.html?lotType=10&width=781&height=510','江苏快3直播');"  >视频开奖</a>
            </div>
            <div id="cate_menus_61" class="hide cate_menu">
				...
				|
                <a style="background: linear-gradient(to bottom, #ff925f 0%,#ff7340 100%);color: #FFFFFF;cursor: pointer; border: 1px solid #ff6835; border-radius: 3px;margin-top:3px"  onclick="shipinzhibo('http://www.163kai.com/threeLevelPage/lotteryQuote.html?lotType=28&width=781&height=510','幸运农场直播');"  >视频开奖</a>
            </div>
            <div id="cate_menus_65" class="hide cate_menu">
                ...
                <a href="/game/bjkl8/sol.html" onclick="HomeMenu.selCateMenuClass(this);" target="framePage"
                   cate_id="2">正码</a>
				   	|
                <a style="background: linear-gradient(to bottom, #ff925f 0%,#ff7340 100%);color: #FFFFFF;cursor: pointer; border: 1px solid #ff6835; border-radius: 3px;margin-top:3px"  onclick="shipinzhibo('http://www.163kai.com/threeLevelPage/lotteryQuote.html?lotType=23&width=781&height=510','北京快乐8直播');"  >视频开奖</a>
            </div>
            ...
            <div id="cate_menus_21" class="hide cate_menu">
                ...
                <a href="/game/gd11x5/zx.html" onclick="HomeMenu.selCateMenuClass(this);" target="framePage"
                   cate_id="1">直选</a>
				|
                <a style="background: linear-gradient(to bottom, #ff925f 0%,#ff7340 100%);color: #FFFFFF;cursor: pointer; border: 1px solid #ff6835; border-radius: 3px;margin-top:3px"  onclick="shipinzhibo(' http://www.163kai.com/threeLevelPage/lotteryQuote.html?lotType=15&width=781&height=510','广东11选5直播');"  >视频开奖</a>
            </div>
    ...
    <div class="main clearfix">
        ...
        <div class="siderbar" id="left_main">
            <div class="side_left">
                ...
                <?php } ?>
                 <div class="title trial-cls sider_fl"><a href="/center/user/loginpwd.html" target="framePage">
                 	个人中心
                 ...
                 <div class="title trial-cls sider_fl"><a href="/center/pay/index.html?v6" target="framePage">充值</a></div>
                <div class="title trial-cls sider_fl"><a href="/center/withdraw/index.html" target="framePage">提款</a></div>	
                	
         
               <div class="title trial-user kf"><a href="<?=$this->settings['zxkfUrl']?>" target="_blank">在线客服</a></div>
                <div class="title trial-cls"><a href="/center/pay/list.html" target="framePage">存取纪录</a></div>
			
				
               
                <div class="title ">最新注单</div>
