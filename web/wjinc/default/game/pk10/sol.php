...
<div id="resultList" class="tuozhuai menu1 " >
	<div class="result_list_header">
		<span>弹窗可拖动</span>
		<span onclick=" breakeds(50)" style="margin-left:50px;color:red;float: left">刷新</span>
		<div class="result_list_close" onclick="$('#resultList').hide();">×</div>
		<div id="resultListHeader" style="background:Gainsboro;text-align:center;font-weight: bold;">北京赛车1(PK10) - 结果走势</div>
	</div>
