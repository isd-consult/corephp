...
<!--       <label> <input type="checkbox" class="u-cb1" /> 预设 </label>  -->
    ...
    <div class="cont-col3-bd" id="bet_tab"> 
     <table class="u-table2 play_tab_56 "> 
      ...
      <tbody> 
	   ...
	   <td id="play_name_106102" class="name K3Term">小</td> 
		...
		<td id="play_name_106103" class="name K3Term">单</td> 
        <td id="play_odds_106103" class="odds"><span class="c-txt3">--</span></td> 
        <td id="play_text_106103" class="amount"><input type="text" /></td>
		
		<td id="play_name_106104" class="name K3Term">双</td> 
        <td id="play_odds_106104" class="odds"><span class="c-txt3">--</span></td> 
        <td id="play_text_106104" class="amount"><input type="text" /></td>
	   </tr>
      </tbody> 
     </table> 
     ...
     <table class="u-table2 play_tab_57 mt5"> 
      <thead> 
      	<tr> 
        <th colspan="9">围骰（单选豹子）、全骰（通选豹子）</th> 
       </tr> 
      </thead> 
      <tbody> 
       <tr> 
