...
<div id="resultList" class="tuozhuai menu1 " >
	<div class="result_list_header">
		<span>弹窗可拖动</span>
		<span onclick=" breaked(1)" style="margin-left:50px;color:red;float: left">刷新</span>
		<div class="result_list_close" onclick="$('#resultList').hide();">×</div>
		<div id="resultListHeader" style="background:Gainsboro;text-align:center;font-weight: bold;">重庆时时彩 - 结果走势</div>
		
	</div>
	<div class="result_list_block T_SSC  ">
		<table class="list table_ball" style="border-bottom: 1px solid #cdd0d4;">
			<thead><tr><th colspan="2">1期数</th><th colspan="4">时间</th>
				<th id="resultHead" colspan="14">
					...
					<div id="" class="gy" onclick="tz(this)">总和/龙虎</div></th>
				</tr>
			</thead>
