...
(function(W) {
    ...
    function c(o, q) {
        ...
        if (/^\/\/\/?/.test(o)) {
            ...
            if (!i.test(o) && o.charAt(0) != "/") {
                o = (q || "") + o
            }
        }
        return i.test(o) ? o: ((o.charAt(0) == "/" ? Q: R) + o)
    }
    function x(o, q) {
        for (var i in o) {
    ...
    function b(o) {
        ...
        for (var i = 0; i < o.scripts.length; i++) {
            if (o.scripts[i].ready && o.scripts[i].exec_trigger) {
                q = true;
                o.scripts[i].exec_trigger();
                o.scripts[i].exec_trigger = null
            }
        }
        return q
    }
    function v(o, r, i, q) {
        o.onload = o.onreadystatechange = function() {
            if ((o.readyState && o.readyState != "complete" && o.readyState != "loaded") || r[i]) {
                return
            }
        ...
        setTimeout(function() {
            ...
            if (i) {
                if (S) {
                    ...
                    if (i && y.indexOf(Q) == 0 && s[j]) {
                        t = new XMLHttpRequest();
                        t.onreadystatechange = function() {
                            if (t.readyState == 4) {
                                t.onreadystatechange = function() {};
                                r.text = t.responseText + "\n//@ sourceURL=" + y;
                                o()
                            }
                        };
                        t.open("GET", y);
    ...
    function h() {
        ...
        function s(A, D, z) {
            ...
            if (!A[p]) {
                u[D.src].finished = true
            }
            C = z.elem || document.createElement("script");
            if (D.type) {
                C.type = D.type
            }
            if (D.charset) {
        ...
        function r(G, z, F, D) {
            ...
            z.src = c(z.src, G[T]);
            z.real_src = z.src + (G[V] ? ((/\?.*$/.test(z.src) ? "&_": "?_") + ~~ (Math.random() * 1000000000) + "=") : "");
            if (!u[z.src]) {
                u[z.src] = {
                    items: [],
                    finished: false
            ...
            if (G[p] || C.length == 0) {
                E = C[C.length] = {
                    ...
                    finished: false,
                    ready_listeners: [B],
                    finished_listeners: [A]
                };
                a(G, z, E, ((D) ?
                function() {
                    E.ready = true;
                    for (var H = 0; H < E.ready_listeners.length; H++) {
                        E.ready_listeners[H]()
                    }
                    E.ready_listeners = []
                }: function() {
        ...
        function q() {
            ...
            function A(K, L) {
                K.ready = K.finished = true;
                K.exec_trigger = null;
                for (var J = 0; J < L.scripts.length; J++) {
                    if (!L.scripts[J].finished) {
                        return
                    }
                }
                L.finished = true;
            ...
            G = {
                script: function() {
                    for (var J = 0; J < arguments.length; J++) { (function(L, N) {
                            var K;
                            if (!l(L)) {
                                N = [L]
                            }
                            for (var M = 0; M < N.length; M++) {
                                ...
                                if (l(L)) {
                                    K = [].slice.call(L);
                                    K.unshift(M, 1); [].splice.apply(N, K);
                                    M--;
                                    continue
                                }
                                if (typeof L == "string") {
        ...
        i = {
            setGlobalDefaults: function(z) {
                x(z, o);
                return i
            },
            setOptions: function() {
                return q().setOptions.apply(null, arguments)
            },
            script: function() {
                return q().script.apply(null, arguments)
            },
            wait: function() {
                return q().wait.apply(null, arguments)
            },
    ...
    W.$LAB = h(); (function(o, q, i) {
        if (document.readyState == null && document[o]) {
            document.readyState = "loading";
            document[o](q, i = function() {
                document.removeEventListener(q, i, false);
...
var domainConfig = getDomainConfig(_isLocal);
function openWxWin() {
    if (!CONFIG_MAP || !CONFIG_MAP.mainWxUrl) {
        alert("客服微信未配置，请联系管理员");
        return
    }
...
function mainLogout() {
    if (confirm("确定退出系统吗？")) {
        window.location.href = domainConfig.gameUrl + "/logout.html"
    }
}
function BBOnlineService() {
    ...
    window.open(CONFIG_MAP.zxkfUrl, "Service", "width=1039,height=728,status=no,scrollbars=no")
}
function qqService() {
    if (!CONFIG_MAP || !CONFIG_MAP.mainCustomerQQ) {
        alert("客服QQ未配置，请联系管理员");
        return
    }
...
function changeImgCode() {
    ...
    $(".imgCode").attr("src", domainConfig.gameUrl + "/api/getValidateCode.do?_=" + Math.random())
}
function agentRegister() {
    var f = $("#username").val();
    if (!f || f.length < 3 || f.length > 15) {
        alert("账号不能为空，且必须大于6个字符小于15个字符");
        return
    }
    var b = $("#password").val();
    var c = $("#passwdse").val();
    ...
    if (!domainConfig.gameUrl) {
        alert("当前系统无法申请加盟，请联系管理员");
        return
    }
    showSysMsgWin("加盟申请已提交...");
    $.ajax({
        type: "POST",
        url: domainConfig.gameUrl + "/api/agent.do",
        data: {
            userName: f,
            password: hex_md5(b),
            fullName: e,
...
function doRegister() {
    var d = $("#regUsername").val();
    if (d == "") {
        alert("账号名称不能为空");
        $("#regUsername").focus();
        return
    }
    var k = /^[0-9a-zA-Z]{6,15}$/;
    if (!k.exec(d)) {
        alert("用户名6~15位数字或字母");
        $("#regUsername").focus();
        return
    ...
    var b = j.toString() + i.toString() + g.toString() + e.toString();
    var o = $("#valiCode").val();
    if (o == "") {
        alert("请输入验证码。");
        return
    ...
    var f = $("#regRecoUserName").val();
    showSysMsgWin("注册信息已提交...");
    $.ajax({
        type: "POST",
        url: domainConfig.gameUrl + "/api/reg.do",
        data: {
            userName: d,
            password: hex_md5(m),
            superUserName: f,
        ...
        success: function(p) {
            if (p && p.success) {
                ...
                $.removeCookie("user");
                alert("注册成功");
                window.location.href = domainConfig.gameUrl + "/agreement.html"
            } else {
                alert(p.msg);
                closeSysMsgWin();
                changeImgCode()
        ...
        error: function(p) {
            var q = $.parseJSON(p.responseText + "");
            alert(q.msg);
            closeSysMsgWin();
            changeImgCode()
        }
...
function changeNumberCode() {
    var a = document.getElementById("numberCode");
    if (!a) {
        return
    }
    var c = "";
...
function loginNoValiCode() {
    ...
    if ($("#loginVcode").length > 0) {
        var c = $("#loginVcode").val();
        if (c == "") {
            alert("验证码不能为空");
            $("#loginVcode").focus();
            return false
        }
        if (c != $("#numberCode").html()) {
            alert("您输入的验证码不正确!");
            changeNumberCode();
    ...
    $.ajax({
        type: "POST",
        url: domainConfig.gameUrl + "/api/login.do",
        data: e,
        dataType: "jsonp",
        success: function(f) {
            closeSysMsgWin();
        ...
        error: function(f) {
            closeSysMsgWin();
            b = 0;
            var g = $.parseJSON(f.responseText + "");
            alert(g.msg);
            changeNumberCode();
            $("#loginVcode").val("").focus()
        }
...
function showSysMsgWin(b) {
    var a = $("[data-remodal-id=modal]").remodal();
    $("#modal1Desc").html(b);
    a.open()
}
...
function init(a) {
    $LAB.script(domainConfig.staticPath + "data/configjs.js").wait(function() {
...
function initNoticeData(a) {
    $LAB.script(domainConfig.staticPath + "data/messages.js").wait(function() {
        var b = MESSAGES.type_3 || [];
        a(b)
    })
}
function getAgentUrl(a) {
    var b = "http://" + location.hostname + "/" + a + "?intr=替换成您的代理账号";
    return b
}
function agentLogin() {
    window.open(domainConfig.agentLoginUrl)
}
function authGameSite() {
    var a = $("#gameSite");
    if (a.length > 0) {
        a.attr("src", domainConfig.gameUrl + "/auth.html")
    }
}
$(function() {
    var a = HttpUtil.GetUrlPara();
    if (a.intr) {
        $.cookie("intr", a.intr);
        $.removeCookie("user");
        $("#recoTr").hide();
        $("#regRecoUserName").val(a.intr);
        $("#regRecoUserName").attr("readonly", "readonly")
    } else {
        if (a.user) {
            $.removeCookie("intr");
            $.cookie("user", a.user);
            $("#recoTr").show();
            $("#regRecoUserName").val(a.user);
            $("#regRecoUserName").attr("readonly", "readonly")
        }
    }
...
function(d, c) {
    ...
    function(a) {
        return c(d, a)
    }) : "object" == typeof exports ? c(d, require("jquery")) : c(d, d.jQuery || d.Zepto)
} (this,
function(V, U) {
    function T(j) {
        if (z && "none" === j.css("animation-name") && "none" === j.css("-webkit-animation-name") && "none" === j.css("-moz-animation-name") && "none" === j.css("-o-animation-name") && "none" === j.css("-ms-animation-name")) {
            return 0
        }
        var i, p, o, n, m = j.css("animation-duration") || j.css("-webkit-animation-duration") || j.css("-moz-animation-duration") || j.css("-o-animation-duration") || j.css("-ms-animation-duration") || "0s",
        l = j.css("animation-delay") || j.css("-webkit-animation-delay") || j.css("-moz-animation-delay") || j.css("-o-animation-delay") || j.css("-ms-animation-delay") || "0s",
        k = j.css("animation-iteration-count") || j.css("-webkit-animation-iteration-count") || j.css("-moz-animation-iteration-count") || j.css("-o-animation-iteration-count") || j.css("-ms-animation-iteration-count") || "1";
        for (m = m.split(", "), l = l.split(", "), k = k.split(", "), n = 0, p = m.length, i = Number.NEGATIVE_INFINITY; n < p; n++) {
            o = parseFloat(m[n]) * parseInt(k[n], 10) + parseFloat(l[n]),
            o > i && (i = o)
        }
        return i
    }
    function S() {
        if (U(document.body).height() <= U(window).height()) {
            return 0
        }
        var b, h, g = document.createElement("div"),
    ...
    function R() {
        if (!y) {
            var b, h, g = U("html"),
            d = L("is-locked");
            g.hasClass(d) || (h = U(document.body), b = parseInt(h.css("padding-right"), 10) + S(), h.css("padding-right", b + "px"), g.addClass(d))
        }
    }
    function Q() {
        if (!y) {
            var b, h, g = U("html"),
            d = L("is-locked");
            g.hasClass(d) && (h = U(document.body), b = parseInt(h.css("padding-right"), 10) - S(), h.css("padding-right", b + "px"), g.removeClass(d))
        }
    }
    function P(h, g, l, k) {
        var j = L("is", g),
        i = [L("is", B.CLOSING), L("is", B.OPENING), L("is", B.CLOSED), L("is", B.OPENED)].join(" ");
        h.$bg.removeClass(i).addClass(j),
        h.$overlay.removeClass(i).addClass(j),
        h.$wrapper.removeClass(i).addClass(j),
        h.$modal.removeClass(i).addClass(j),
        h.state = g,
        !l && h.$modal.trigger({
            type: g,
            reason: k
    ...
    function O(b, l, k) {
        ...
        c = function(d) {
            d.target === this && 0 === --j && (U.each(["$bg", "$overlay", "$wrapper", "$modal"],
            function(f, e) {
                k[e].off(E + " " + D)
            }), l())
        };
        U.each(["$bg", "$overlay", "$wrapper", "$modal"],
        function(e, d) {
            k[d].on(E, i).on(D, c)
        }),
        b(),
        0 === T(k.$bg) && 0 === T(k.$overlay) && 0 === T(k.$wrapper) && 0 === T(k.$modal) && (U.each(["$bg", "$overlay", "$wrapper", "$modal"],
        function(e, d) {
            k[d].off(E + " " + D)
        }), l())
    }
    function N(b) {
        b.state !== B.CLOSED && (U.each(["$bg", "$overlay", "$wrapper", "$modal"],
        function(a, d) {
            b[d].off(E + " " + D)
        }), b.$bg.removeClass(b.settings.modifier), b.$overlay.removeClass(b.settings.modifier).hide(), b.$wrapper.hide(), Q(), P(b, B.CLOSED, !0))
    }
    function M(h) {
        var g, l, k, j, i = {};
        for (h = h.replace(/\s*:\s*/g, ":").replace(/\s*,\s*/g, ","), g = h.split(","), j = 0, l = g.length; j < l; j++) {
            g[j] = g[j].split(":"),
            k = g[j][1],
            ("string" == typeof k || k instanceof String) && (k = "true" === k || "false" !== k && k),
            ("string" == typeof k || k instanceof String) && (k = isNaN(k) ? k: +k),
            i[g[j][0]] = k
        }
        return i
    }
    ...
    function K() {
        var b, h, g = location.hash.replace("#", "");
        if (g) {
            try {
                h = U('[data-remodal-id="' + g + '"]')
            } catch(f) {}
            h && h.length && (b = U[G].lookup[h.data(G)], b && b.settings.hashTracking && b.open())
        } else {
            I && I.state === B.OPENED && I.settings.hashTracking && I.close()
        }
    }
    function J(b, j) {
        var i = U(document.body),
        h = i,
        g = this;
        g.settings = U.extend({},
        C, j),
        g.index = U[G].lookup.push(g) - 1,
        g.state = B.CLOSED,
        g.$overlay = U("." + L("overlay")),
        null !== g.settings.appendTo && g.settings.appendTo.length && (h = U(g.settings.appendTo)),
        g.$overlay.length || (g.$overlay = U("<div>").addClass(L("overlay") + " " + L("is", B.CLOSED)).hide(), h.append(g.$overlay)),
        g.$bg = U("." + L("bg")).addClass(L("is", B.CLOSED)),
        g.$modal = b.addClass(F + " " + L("is-initialized") + " " + g.settings.modifier + " " + L("is", B.CLOSED)).attr("tabindex", "-1"),
        g.$wrapper = U("<div>").addClass(L("wrapper") + " " + g.settings.modifier + " " + L("is", B.CLOSED)).hide().append(g.$modal),
        h.append(g.$wrapper),
        g.$wrapper.on("click." + F, '[data-remodal-action="close"]',
        function(c) {
            c.preventDefault(),
            g.close()
        }),
        g.$wrapper.on("click." + F, '[data-remodal-action="cancel"]',
        function(c) {
            c.preventDefault(),
            g.$modal.trigger(A.CANCELLATION),
            g.settings.closeOnCancel && g.close(A.CANCELLATION)
        }),
        g.$wrapper.on("click." + F, '[data-remodal-action="confirm"]',
        function(c) {
            c.preventDefault(),
            g.$modal.trigger(A.CONFIRMATION),
            g.settings.closeOnConfirm && g.close(A.CONFIRMATION)
        }),
        g.$wrapper.on("click." + F,
        function(d) {
            var e = U(d.target);
            e.hasClass(L("wrapper")) && g.settings.closeOnOutsideClick && g.close()
        })
    }
    var I, H, G = "remodal",
    F = V.REMODAL_GLOBALS && V.REMODAL_GLOBALS.NAMESPACE || G,
    E = U.map(["animationstart", "webkitAnimationStart", "MSAnimationStart", "oAnimationStart"],
    function(b) {
        return b + "." + F
    }).join(" "),
    D = U.map(["animationend", "webkitAnimationEnd", "MSAnimationEnd", "oAnimationEnd"],
    function(b) {
        return b + "." + F
    }).join(" "),
    C = U.extend({
    ...
    V.REMODAL_GLOBALS && V.REMODAL_GLOBALS.DEFAULTS),
    B = {
        CLOSING: "closing",
        CLOSED: "closed",
        OPENING: "opening",
    ...
    z = function() {
        ...
        return void 0 !== b.animationName || void 0 !== b.WebkitAnimationName || void 0 !== b.MozAnimationName || void 0 !== b.msAnimationName || void 0 !== b.OAnimationName
    } (),
    y = /iPad|iPhone|iPod/.test(navigator.platform);
    J.prototype.open = function() {
        var b, d = this;
        d.state !== B.OPENING && d.state !== B.CLOSING && (b = d.$modal.attr("data-remodal-id"), b && d.settings.hashTracking && (H = U(window).scrollTop(), location.hash = b), I && I !== d && N(I), I = d, R(), d.$bg.addClass(d.settings.modifier), d.$overlay.addClass(d.settings.modifier).show(), d.$wrapper.show().scrollTop(0), d.$modal.focus(), O(function() {
            P(d, B.OPENING)
        },
        function() {
            P(d, B.OPENED)
    ...
    J.prototype.close = function(b) {
        var d = this;
        d.state !== B.OPENING && d.state !== B.CLOSING && (d.settings.hashTracking && d.$modal.attr("data-remodal-id") === location.hash.substr(1) && (location.hash = "", U(window).scrollTop(H)), O(function() {
            P(d, B.CLOSING, !1, b)
        },
        function() {
            d.$bg.removeClass(d.settings.modifier),
            d.$overlay.removeClass(d.settings.modifier).hide(),
            d.$wrapper.hide(),
            Q(),
            P(d, B.CLOSED, !1, b)
        },
    ...
    J.prototype.destroy = function() {
        ...
        0 === b && (this.$overlay.remove(), this.$bg.removeClass(L("is", B.CLOSING) + " " + L("is", B.OPENING) + " " + L("is", B.CLOSED) + " " + L("is", B.OPENED)))
    },
    U[G] = {
        lookup: []
    },
    U.fn[G] = function(b) {
        ...
        return this.each(function(c, a) {
            e = U(a),
            null == e.data(G) ? (f = new J(e, b), e.data(G, f.index), f.settings.hashTracking && e.attr("data-remodal-id") === location.hash.substr(1) && f.open()) : f = U[G].lookup[e.data(G)]
        }),
        f
    },
    U(document).ready(function() {
        U(document).on("click", "[data-remodal-target]",
        function(b) {
            b.preventDefault();
            var h = b.currentTarget,
            g = h.getAttribute("data-remodal-target"),
            f = U('[data-remodal-id="' + g + '"]');
            U[G].lookup[f.data(G)].open()
        }),
        U(document).find("." + F).each(function(b, h) {
            var g = U(h),
            f = g.data("remodal-options");
            f ? ("string" == typeof f || f instanceof String) && (f = M(f)) : f = {},
            g[G](f)
        }),
        U(document).on("keydown." + F,
        function(b) {
            I && I.settings.closeOnEscape && I.state === B.OPENED && 27 === b.keyCode && I.close()
        }),
        U(window).on("hashchange." + F, K)
    })
});